...
<html lang="en">
  <head>
    ...
    <title>Jardin Etena Primavera - Dueño</title>
    ...
    <header class="header sticky-bar header-style-1">
      <div class="container">
        <div class="main-header">
          <div class="header-logo"><a class="d-flex" href="index-vendedor.html"><img alt="JardinEternaPrimavera" src="assets/imgs/template/logo.png"></a></div>
          <div class="header-menu">
            <div class="header-nav">
              <nav class="nav-main-menu d-none d-xl-block">
                <ul class="main-menu">
                  <li class="has-mega-menu"><a class="active" href="index-vendedor.html">Inicio</a></li>
                  <li><a href="Reserve-vendedor.html">Pedidos/Reservas</a></li>
                  <li><a href="agregate-product.html">Agregar nuevo producto</a></li>
                  <li><a href="changes-vendedor-administrator.html">Notificar/Realizar cambios</a></li>
                  <li><a href="my-account-vendedor.html">Mi cuenta</a></li>
                </ul>
              </nav>
    ...
    <main class="main">
      <div class="top-head-blog">
        <div class="text-center">
          <h2 class="font-4xl-bold">Bienvenido Dueño</h2>
        </div>
      </div>   
        ...
        <div class="box-account-wrapper"><a class="btn-close-popup btn-close-popup-account" href="#">
          ...
          <div class="form-account-info"><a class="button-tab btn-for-login active" href="#">Iniciar Sesion</a><a class="button-tab btn-for-signup" href="#">Registrarse</a>
            <div class="form-login">
              ...
              <div class="form-group">
                <button class="btn btn-login d-block">Iniciar sesion</button>
              </div>
            ...
            <div class="form-register">
              ...
              <div class="form-group">
                <button class="btn btn-login d-block">Crear cuenta</button>
              </div>
              <div class="text-center">
